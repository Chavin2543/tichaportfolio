            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
                    ...
                    <div className="mx-auto grid w-full max-w-xl grid-cols-2 items-center gap-y-12 gap-x-12 sm:gap-y-14 lg:mx-0 lg:max-w-none lg:pl-8">
                        <span className="bg-white inline-flex items-center gap-x-1.5 rounded-md px-2 py-1 text-l text-bold font-medium text-black ring-1 ring-inset ring-white hover:bg-gray-600">
