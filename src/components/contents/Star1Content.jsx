...
export function Star1Content() {
    return (
        <div className="px-6 py-32 lg:px-8 h-full overflow-auto">
            <div className="mx-auto max-w-3xl rounded-3xl p-8 text-base leading-7 text-gray-700">
                ...
                <div className="mt-10 max-w-2xl">
                    ...
                    <ul role="list" className="mt-8 max-w-xl space-y-8 text-gray-600">
                        <li className="flex gap-x-3">
                            ...
                            <span>
                                <strong className="font-semibold text-gray-900">Review available documentation </strong>
                            and conduct interviews with key stakeholders to develop an understanding of your current operations
                            </span>
                        </li>
                        <li className="flex gap-x-3">
                            <CheckCircleIcon className="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                            <span>
                                <strong className="font-semibold text-gray-900">Review financial statements </strong>
                                to understand historical financial performance and key trends
                            </span>
                        </li>
                        <li className="flex gap-x-3">
                            <CheckCircleIcon className="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                            <span>
                                <strong className="font-semibold text-gray-900"> Identify </strong>
                            and summarize potential inefficiencies and challenges
                            </span>
                        </li>
                    </ul>
                    <p className="mt-8">
